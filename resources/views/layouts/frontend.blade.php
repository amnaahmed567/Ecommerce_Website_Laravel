  ...
  <body>
    ...
    <div class="humberger__menu__wrapper">
      ...
      <div class="humberger__menu__contact">
        <ul>
          <li><i class="fa fa-envelope"></i> snal@seecs.com</li>
        ...
        <div class="row">
          <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="footer__about">
              ...
              <ul>
                <li>Address: 60-49 Road 11378 Multan</li>
                <li>Phone: +92 12324564</li>
                <li>Email: snal@seecs.com</li>
              </ul>
            </div>
          </div>
          ...
          <div class="col-lg-12">
            <div class="footer__copyright">
              <div class="footer__copyright__text">
                <p>
                  <!-- Link back to snal can't be removed. Template is licensed under CC BY 3.0. -->
                  Copyright &copy;
                  <script>
                  ...
                  <a href="https://snal.com" target="_blank">snal</a>
                  <!-- Link back to snal can't be removed. Template is licensed under CC BY 3.0. -->
                </p>
              </div>
